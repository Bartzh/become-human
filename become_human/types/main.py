...
class MainState(BaseModel):
    ...
    #core_prompts: list[tuple[str, str]] = Field(default_factory=list, description="给插件的自定义core prompt标题和内容")
    #secondary_prompts: list[tuple[str, str]] = Field(default_factory=list, description="给插件的自定义secondary prompt标题和内容")
